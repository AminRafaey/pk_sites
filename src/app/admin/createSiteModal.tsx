...
export default function CreateSiteModal() {
  ...
  return (
    <form
      onSubmit={async (e) => {
        e.preventDefault();
        const addedDomain = await addDomainToVercel(data.subdomain);
        console.log('There you go...👉🏻 submit', addedDomain);
      }}
      //   action={async (mData: FormData) =>
      //     createSite(mData).then((res: any) => {
      //       if (res.error) {
...
function CreateSiteFormButton() {
  ...
  return (
    ...
    >
      <p>Create Site</p>
      {/* {pending ? <CircularProgress color="primary" /> : <p>Create Site</p>} */}
    </button>
  );
}
