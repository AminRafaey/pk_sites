...
// options
import { makePreset, Preset, presets } from './options/presets';
...
export default function ThemeProvider({ children, customPreset }: Props) {
  const settings = useSettingsContext();

  const darkModeOption = darkMode(settings.themeMode);

  const presetsOption = customPreset ? makePreset(customPreset) : presets('orange');
